...
import { X, ArrowRightLeft, Building2, Layers } from 'lucide-react';
      ...
      <AnimatePresence>
        {totalSelected > 0 && (
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pt-2 md:pb-6 md:pt-3 bg-slate-800/95 backdrop-blur-md shadow-[0_-10px_40px_rgba(15,23,42,0.15)] border-t border-slate-700"
          >
            ...
            <div className="flex gap-1 bg-slate-900/50 p-0.5 rounded-lg text-xs font-semibold text-slate-400 border border-slate-750/30">
              ...
              >
                ...
                <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-black transition-colors ${
                  comparedListings.length > 0 ? 'bg-primary-650 text-white' : 'bg-slate-750 text-slate-450'
                }`}>
              ...
              >
                ...
                <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-black transition-colors ${
                  comparedProjects.length > 0 ? 'bg-primary-650 text-white' : 'bg-slate-750 text-slate-450'
                }`}>
          ...
          <div className="flex items-center gap-3 shrink-0 w-full md:w-auto justify-end border-t md:border-t-0 pt-2 md:pt-0 border-slate-750">
            ...
            <Link
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all shadow-md shrink-0 ${
                activeIds.length >= 2
