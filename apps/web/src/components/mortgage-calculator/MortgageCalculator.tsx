...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    termsText: 'By clicking the \'Submit Request\' button you are agreeing to Saudi RE\'s ',
  ...
  ar: {
    ...
    termsText: 'بالنقر فوق الزر "إرسال الطلب" فإنك توافق على الشروط والأحكام الخاصة بـ Saudi RE ',
