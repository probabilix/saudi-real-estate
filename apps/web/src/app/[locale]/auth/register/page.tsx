            ...
            {!showEmailForm ? (
              ...
              >
                <button
                  ...
                  className="sm:col-span-2 flex items-center justify-center gap-3 px-6 py-4 border border-gray-100 rounded-2xl bg-white hover:bg-gray-50 transition-all font-bold text-gray-700 shadow-sm"
                >
